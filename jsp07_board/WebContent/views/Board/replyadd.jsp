...
<body>
	...
	<form name="frmReply" action="${path}/reply/replyadd" method="post">
		<input type="text" value="${param.ref}" name="ref">
		<input type="text" value="${param.restep}" name="restep">
		<input type="text" value="${param.relevel}" name="relevel">
